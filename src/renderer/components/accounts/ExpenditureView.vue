      ...
      el-tab-pane(name="details", label='Employee Details')
        ...
        .mt-30
          ...
          el-table(
            ...
            //- el-table-column(prop="tax", show-overflow-tooltip, label="Tax", align="center" sortable)
            ...
            //- el-table-column(prop="profit", show-overflow-tooltip, label="Profit", align="center" sortable)     
